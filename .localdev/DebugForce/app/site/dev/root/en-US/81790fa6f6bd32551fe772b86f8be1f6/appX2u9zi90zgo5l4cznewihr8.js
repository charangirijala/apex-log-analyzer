(function() { LWR.define('webruntime/appX2u9zi90zgo5l4cznewihr8', ['exports', 'lwc', 'webruntime/app', '@view/scopedHeaderAndFooter', '@view/checkPasswordResetEmail', 'webruntime/bootstrapHook', 'force/ldsEngineWebruntime', 'force/luvioRuntimeWebruntime', 'dxp_data_provider/imageDataProvider', 'dxp_data_provider/userDataProvider', 'dxp_data_provider/userRecordDataProvider'], (function (exports, lwc, App, appView, routerContainerView, bootstrapHook, ldsEngineWebruntime, luvioRuntimeWebruntime, dataProvider0, dataProvider1, dataProvider2) {
    ...
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-3bhlobgjjs1";
    tmpl.legacyStylesheetToken = "webruntime-appX2u9zi90zgo5l4cznewihr8_appX2u9zi90zgo5l4cznewihr8";
    ...
    const __lwc_component_class_internal = lwc.registerComponent(RouteApp, {
      tmpl: _tmpl,
      sel: "webruntime-app-x2u9zi90zgo5l4cznewihr8",
      apiVersion: 62
    });
