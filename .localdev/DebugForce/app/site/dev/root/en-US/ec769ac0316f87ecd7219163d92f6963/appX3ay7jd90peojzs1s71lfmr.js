(function() { LWR.define('webruntime/appX3ay7jd90peojzs1s71lfmr', ['exports', 'lwc', 'webruntime/app', '@view/scopedHeaderAndFooter', '@view/newsDetail', 'webruntime/expressions', 'webruntime/bootstrapHook', 'force/ldsEngineWebruntime', 'force/luvioRuntimeWebruntime', 'dxp_data_provider/cmsV2SingleItemDataProvider', 'dxp_data_provider/userDataProvider', 'dxp_data_provider/userRecordDataProvider'], (function (exports, lwc, App, appView, routerContainerView, expressions, bootstrapHook, ldsEngineWebruntime, luvioRuntimeWebruntime, dataProvider0, dataProvider1, dataProvider2) {
    ...
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-2mtpt45e0jl";
    tmpl.legacyStylesheetToken = "webruntime-appX3ay7jd90peojzs1s71lfmr_appX3ay7jd90peojzs1s71lfmr";
    ...
    const __lwc_component_class_internal = lwc.registerComponent(RouteApp, {
      tmpl: _tmpl,
      sel: "webruntime-app-x3ay7jd90peojzs1s71lfmr",
      apiVersion: 62
    });
    ...
    function _getServerData() {
      _getServerData = _asyncToGenerator(function* (context) {
        ...
        yield Promise.all([dataProvider0__default.default.preloadData?.({
          ...
          attributes: [{
            "sfdcFields": [],
            "contentKey": expressions.EXPR_CLOSURE(() => cmp.routeParams["urlAlias"] || ""),
            "sfdcIsViewLevelDataProvider": true,
            "sfdcType": {
              "fqn": "sfdc_cms__news",
              "type": "cms"
            }
          ...
          throw new Error(`Error in "getServerData" for "dxp_data_provider/cmsV2SingleItemDataProvider"${err.message ? ': ' + err.message : ''}`, {
            cause: err
          });
        ...
        const areAllSSRableDataProvidersStatic = [!dataProvider0__default.default.preloadData, !dataProvider1__default.default.preloadData, !dataProvider2__default.default.preloadData].reduce((acc, isDPStatic) => acc && isDPStatic, true);
