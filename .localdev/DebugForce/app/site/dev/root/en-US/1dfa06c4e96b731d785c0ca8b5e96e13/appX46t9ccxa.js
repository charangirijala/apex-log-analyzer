(function() { LWR.define('webruntime/appX46t9ccxa', ['exports', 'lwc', 'webruntime/app', '@view/scopedHeaderAndFooter', '@view/login', 'webruntime/bootstrapHook', 'force/ldsEngineWebruntime', 'force/luvioRuntimeWebruntime', 'dxp_data_provider/imageDataProvider', 'dxp_data_provider/userDataProvider', 'dxp_data_provider/userRecordDataProvider'], (function (exports, lwc, App, appView, routerContainerView, bootstrapHook, ldsEngineWebruntime, luvioRuntimeWebruntime, dataProvider0, dataProvider1, dataProvider2) {
    ...
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-667jo3ptgrg";
    tmpl.legacyStylesheetToken = "webruntime-appX46t9ccxa_appX46t9ccxa";
