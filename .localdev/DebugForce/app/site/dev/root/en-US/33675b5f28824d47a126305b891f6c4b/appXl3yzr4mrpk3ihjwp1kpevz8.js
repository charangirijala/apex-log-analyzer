(function() { LWR.define('webruntime/appXl3yzr4mrpk3ihjwp1kpevz8', ['exports', 'lwc', 'webruntime/app', '@view/scopedHeaderAndFooter', '@view/forgotPassword', 'webruntime/bootstrapHook', 'force/ldsEngineWebruntime', 'force/luvioRuntimeWebruntime', 'dxp_data_provider/imageDataProvider', 'dxp_data_provider/userDataProvider', 'dxp_data_provider/userRecordDataProvider'], (function (exports, lwc, App, appView, routerContainerView, bootstrapHook, ldsEngineWebruntime, luvioRuntimeWebruntime, dataProvider0, dataProvider1, dataProvider2) {
    ...
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-igt2d7duvi";
    tmpl.legacyStylesheetToken = "webruntime-appXl3yzr4mrpk3ihjwp1kpevz8_appXl3yzr4mrpk3ihjwp1kpevz8";
    ...
    const __lwc_component_class_internal = lwc.registerComponent(RouteApp, {
      tmpl: _tmpl,
      sel: "webruntime-app-xl3yzr4mrpk3ihjwp1kpevz8",
      apiVersion: 62
    });
