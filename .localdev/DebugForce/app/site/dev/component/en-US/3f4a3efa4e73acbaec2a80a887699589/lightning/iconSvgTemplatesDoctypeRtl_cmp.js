(function() { LWR.define('lightning/iconSvgTemplatesDoctypeRtl', ['exports', 'lwc'], (function (exports, lwc) {
    ...
    var doctype_ai = lwc.registerTemplate(tmpl$F);
    tmpl$F.stylesheets = [];
    tmpl$F.stylesheetToken = "lwc-mt2cjovp3h";
    tmpl$F.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_ai";
    ...
    var doctype_attachment = lwc.registerTemplate(tmpl$E);
    tmpl$E.stylesheets = [];
    tmpl$E.stylesheetToken = "lwc-56oiaau0atp";
    tmpl$E.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_attachment";
    ...
    var doctype_box_notes = lwc.registerTemplate(tmpl$C);
    tmpl$C.stylesheets = [];
    tmpl$C.stylesheetToken = "lwc-5hbk8b9128";
    tmpl$C.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_box_notes";
    ...
    var doctype_csv = lwc.registerTemplate(tmpl$B);
    tmpl$B.stylesheets = [];
    tmpl$B.stylesheetToken = "lwc-7qpubp92h6s";
    tmpl$B.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_csv";
    ...
    var doctype_eps = lwc.registerTemplate(tmpl$A);
    tmpl$A.stylesheets = [];
    tmpl$A.stylesheetToken = "lwc-7d1s5bv9lk2";
    tmpl$A.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_eps";
    ...
    var doctype_folder = lwc.registerTemplate(tmpl$w);
    tmpl$w.stylesheets = [];
    tmpl$w.stylesheetToken = "lwc-62hodfaiphm";
    tmpl$w.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_folder";
    lwc.freezeTemplate(tmpl$w);

    const $fragment1$v = lwc.parseFragment`<svg${"c0"} focusable="false"${"a0:data-key"} aria-hidden="true" viewBox="0 0 560 640" part="icon"${2}><g${3}><path fill="#1b96ff" d="M51 0A51 51 0 000 51v538c0 28 23 51 51 51h458c28 0 51-23 51-51V203L371 0z"${3}/><path fill="#fff" d="M317 395H101v-21h216zm0 48H101v-21h216zm0 48H101v-21h216zm0 48H194v-21h123z"${3}/><path fill="#0b5cab" d="M560 204v10H432s-64-13-62-67c0 0 2 57 60 57z"${3}/><path fill="#aacbff" d="M371 0v146c0 16 11 58 61 58h128z"${3}/></g></svg>`;
    ...
    var doctype_gdoc = lwc.registerTemplate(tmpl$v);
    tmpl$v.stylesheets = [];
    tmpl$v.stylesheetToken = "lwc-6ds0cmtfvud";
    tmpl$v.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_gdoc";
    ...
    var doctype_gform = lwc.registerTemplate(tmpl$t);
    tmpl$t.stylesheets = [];
    tmpl$t.stylesheetToken = "lwc-73q4keldcci";
    tmpl$t.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_gform";
    ...
    var doctype_gpres = lwc.registerTemplate(tmpl$s);
    tmpl$s.stylesheets = [];
    tmpl$s.stylesheetToken = "lwc-54vtu0gmano";
    tmpl$s.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_gpres";
    lwc.freezeTemplate(tmpl$s);

    const $fragment1$r = lwc.parseFragment`<svg${"c0"} focusable="false"${"a0:data-key"} aria-hidden="true" viewBox="0 0 560 640" part="icon"${2}><g${3}><path fill="#3ba755" d="M51 0A50 50 0 001 51v538a50 50 0 0050 51h458c28 0 51-23 51-51V203L371 0z"${3}/><path fill="#fff" d="M101 375v164h215V375zm150 115h50v35h-50zm0-50h50v35h-50zm0-51h50v36h-50zM115 490h122v35H115zm0-50h122v35H115zm0-51h122v36H115z"${3}/><path fill="#22683e" d="M560 203v10H432s-63-12-61-67c0 0 2 57 60 57z"${3}/><path fill="#cdefc4" d="M371 0v145c0 17 11 58 61 58h128z"${3}/></g></svg>`;
    ...
    var doctype_gsheet = lwc.registerTemplate(tmpl$r);
    tmpl$r.stylesheets = [];
    tmpl$r.stylesheetToken = "lwc-64tue0op07g";
    tmpl$r.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_gsheet";
    ...
    var doctype_keynote = lwc.registerTemplate(tmpl$o);
    tmpl$o.stylesheets = [];
    tmpl$o.stylesheetToken = "lwc-5169un53fv5";
    tmpl$o.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_keynote";
    lwc.freezeTemplate(tmpl$o);

    const $fragment1$n = lwc.parseFragment`<svg${"c0"} focusable="false"${"a0:data-key"} aria-hidden="true" viewBox="0 0 560 640" part="icon"${2}><g${3}><path fill="#032d60" d="M515 155c25 0 45 20 45 45v310c0 25-20 45-45 45H45a45 45 0 01-45-45V130c0-25 20-45 45-45h115c38 0 42 12 67 45 21 27 72 25 104 25h184z"${3}/><path fill="#90d0fe" d="M515 181H92a45 45 0 00-45 45v29l45-65h423l45 65v-29c0-25-20-45-45-45z"${3}/><path fill="#1ab9ff" d="M46 555h469c25 0 45-20 45-45V235c0-25-20-45-45-45H93a45 45 0 00-46 44v283c0 13-10 23-23 23a23 23 0 01-23-23 45 45 0 0045 38z"${3}/><path fill="#fff" d="M255 378h36v115h-36zm61 0h36v115h-36zm148-60l-150-62c-4-2-7-3-11-3-1 0-5 0-11 3l-150 62c-3 2-5 5-5 8v9c0 5 4 9 9 9h29v140c0 5 4 9 9 9h45V378h-18c-4 0-6-2-6-6v-12c0-4 2-6 6-6h183c4 0 6 2 6 6v12c0 4-2 6-6 6h-18v115h45c5 0 9-4 9-9V344h29c5 0 9-4 9-9v-8c1-4-1-7-4-9zm-161 5a19 19 0 110-38 19 19 0 010 38z"${3}/></g></svg>`;
    ...
    var doctype_library_folder = lwc.registerTemplate(tmpl$n);
    tmpl$n.stylesheets = [];
    tmpl$n.stylesheetToken = "lwc-2fth627moik";
    tmpl$n.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_library_folder";
    ...
    var doctype_mp4 = lwc.registerTemplate(tmpl$l);
    tmpl$l.stylesheets = [];
    tmpl$l.stylesheetToken = "lwc-50usuhrjg5r";
    tmpl$l.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_mp4";
    ...
    var doctype_psd = lwc.registerTemplate(tmpl$f);
    tmpl$f.stylesheets = [];
    tmpl$f.stylesheetToken = "lwc-382uloptfcs";
    tmpl$f.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_psd";
    lwc.freezeTemplate(tmpl$f);
    ...
    var doctype_quip_sheet = lwc.registerTemplate(tmpl$d);
    tmpl$d.stylesheets = [];
    tmpl$d.stylesheetToken = "lwc-5oggbg90p5i";
    tmpl$d.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_quip_sheet";
    lwc.freezeTemplate(tmpl$d);
    ...
    var doctype_rtf = lwc.registerTemplate(tmpl$b);
    tmpl$b.stylesheets = [];
    tmpl$b.stylesheetToken = "lwc-7undo7bttqb";
    tmpl$b.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_rtf";
    lwc.freezeTemplate(tmpl$b);

    const $fragment1$a = lwc.parseFragment`<svg${"c0"} focusable="false"${"a0:data-key"} aria-hidden="true" viewBox="0 0 56 64" part="icon"${2}><g${3}><path d="M51.5 15c2.5 0 4.5 2 4.5 4.5v31c0 2.5-2 4.5-4.5 4.5h-47c-1.19 0-2.34-.47-3.18-1.32A4.471 4.471 0 010 50.5v-38C0 10 2 8 4.5 8H16c3.8 0 4.2 1.2 6.7 4.5 2.1 2.7 7.2 2.5 10.4 2.5h18.4z" fill="#032d60"${3}/><path d="M51.5 17.6H9.2c-1.19 0-2.34.47-3.18 1.32-.84.84-1.32 1.99-1.32 3.18V25l4.5-6.5h42.3L56 25v-2.9c0-2.5-2-4.5-4.5-4.5z" fill="#aacbff"${3}/><path d="M4.6 55h46.9c2.5 0 4.5-2 4.5-4.5V23c0-2.5-2-4.5-4.5-4.5H9.3c-.59-.01-1.18.09-1.73.3s-1.05.53-1.48.94c-.43.41-.77.9-1.01 1.44a4.39 4.39 0 00-.38 1.71v28.3c0 1.3-1 2.3-2.3 2.3-.61 0-1.2-.24-1.63-.67C.34 52.39.1 51.8.1 51.19c.17 1.07.72 2.04 1.54 2.74.83.7 1.88 1.07 2.96 1.06z" fill="#1b96ff"${3}/><path d="M24.72 38.19c-.77-1.15-1.15-2.47-1.15-3.95 0-2.52 1.04-4.61 2.69-5.87-.55-.99-1.65-1.7-3.07-1.7-2.41 0-3.79 1.98-3.79 4.23 0 1.21.38 2.25 1.21 2.96.44.44.82.99.82 1.54s-.22 1.1-1.59 1.7c-1.98.88-3.79 2.09-3.84 3.9.05 1.21.82 2.14 1.98 2.14h1.81c.27 0 .55-.16.71-.44.88-1.59 2.52-2.58 3.9-3.29.49-.22.6-.82.33-1.21zm16.03-1.1c-1.37-.6-1.59-1.1-1.59-1.7s.38-1.15.82-1.54c.82-.77 1.21-1.76 1.21-2.96 0-2.25-1.32-4.23-3.79-4.23-1.43 0-2.52.71-3.13 1.7 1.65 1.26 2.69 3.35 2.69 5.87 0 1.48-.38 2.8-1.15 3.95-.27.44-.11.99.33 1.21 1.37.66 3.02 1.7 3.9 3.29.16.27.44.44.71.44h1.81c1.15 0 1.92-.93 1.92-2.14.05-1.81-1.76-3.02-3.73-3.9zm-6.81 4.01c-1.48-.66-1.76-1.26-1.76-1.87 0-.66.44-1.26.93-1.7.88-.82 1.37-1.98 1.37-3.29 0-2.47-1.48-4.61-4.17-4.61s-4.17 2.14-4.17 4.61c0 1.32.49 2.47 1.37 3.29.49.49.93 1.1.93 1.7 0 .66-.22 1.21-1.76 1.87-2.19.93-4.28 1.98-4.33 3.95 0 1.32.99 2.41 2.25 2.41h11.41c1.26 0 2.25-1.1 2.25-2.41-.05-1.92-2.14-2.96-4.33-3.95z" fill="#fff" fill-rule="evenodd"${3}/></g></svg>`;
    function tmpl$a($api, $cmp, $slotset, $ctx) {
      const {ncls: api_normalize_class_name, sp: api_static_part, st: api_static_fragment} = $api;
      return [api_static_fragment($fragment1$a, 1, [api_static_part(0, {
        className: api_normalize_class_name($cmp.computedClass),
    ...
    var doctype_shared_folder = lwc.registerTemplate(tmpl$a);
    tmpl$a.stylesheets = [];
    tmpl$a.stylesheetToken = "lwc-688eog1lffg";
    tmpl$a.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_shared_folder";
    lwc.freezeTemplate(tmpl$a);
    ...
    var doctype_slide = lwc.registerTemplate(tmpl$9);
    tmpl$9.stylesheets = [];
    tmpl$9.stylesheetToken = "lwc-4ooqim7q0hi";
    tmpl$9.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_slide";
    lwc.freezeTemplate(tmpl$9);

    const $fragment1$8 = lwc.parseFragment`<svg${"c0"} focusable="false"${"a0:data-key"} aria-hidden="true" viewBox="0 0 560 640" part="icon"${2}><g${3}><path fill="#fcc003" d="M51 0A51 51 0 000 51v538c0 28 23 51 51 51h457c28 0 51-23 51-51V203L370 0z"${3}/><path fill="#e4a201" d="M560 204v10H432s-63-13-62-68c0 0 3 58 61 58z"${3}/><path fill="#f9e3b6" d="M371 0v146c0 16 11 58 61 58h128z"${3}/><path fill="#2e2204" d="M102 364v115l61 60h131c9 0 16-7 16-15V364c0-9-7-16-16-16H118c-9 0-16 7-16 16z"${3}/><path fill="#fcc003" d="M275 452H138v-16h137zm0-36H138v-16h137zm0 72h-89v-17h89z"${3}/></g></svg>`;
    ...
    var doctype_stypi = lwc.registerTemplate(tmpl$8);
    tmpl$8.stylesheets = [];
    tmpl$8.stylesheetToken = "lwc-2pkk4u03vgu";
    tmpl$8.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_stypi";
    ...
    var doctype_txt = lwc.registerTemplate(tmpl$7);
    tmpl$7.stylesheets = [];
    tmpl$7.stylesheetToken = "lwc-fhjm5caar3";
    tmpl$7.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_txt";
    ...
    var doctype_unknown = lwc.registerTemplate(tmpl$6);
    tmpl$6.stylesheets = [];
    tmpl$6.stylesheetToken = "lwc-3sosstft00l";
    tmpl$6.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_unknown";
    lwc.freezeTemplate(tmpl$6);

    const $fragment1$5 = lwc.parseFragment`<svg${"c0"} focusable="false"${"a0:data-key"} aria-hidden="true" viewBox="0 0 5600 6400" part="icon"${2}><g${3}><path fill="#730394" d="M515 1A507 507 0 008 509v5384c0 280 227 507 507 507h4578c280 0 507-227 507-507V2032L3710 1z"${3}/><path fill="#3d0157" d="M5598 2035v100H4318s-631-126-613-671c0 1 21 571 600 571z"${3}/><path fill="#e5b9fe" d="M3707 0v1456c0 166 111 579 611 579h1280z"${3}/><path fill="#fff" d="M2453 4553c0 37-16 74-45 98-20 16-525 442-1184 710a135 135 0 01-119-8c-34-21-59-58-61-99a8228 8228 0 010-1401c2-40 27-77 62-100a130 130 0 01118-8 4826 4826 0 011184 712c29 22 45 59 45 96z"${3}/></g></svg>`;
    ...
    var doctype_visio = lwc.registerTemplate(tmpl$4);
    tmpl$4.stylesheets = [];
    tmpl$4.stylesheetToken = "lwc-2fc8bsvfeie";
    tmpl$4.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_visio";
    ...
    var doctype_xml = lwc.registerTemplate(tmpl$1);
    tmpl$1.stylesheets = [];
    tmpl$1.stylesheetToken = "lwc-6n1k7pc2ami";
    tmpl$1.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_xml";
    ...
    var doctype_zip = lwc.registerTemplate(tmpl);
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-1j9l7qtqa29";
    tmpl.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctypeRtl_zip";
