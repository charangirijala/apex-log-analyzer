(function() { LWR.define('lightning/iconSvgTemplatesDoctype', ['exports', 'lwc'], (function (exports, lwc) {
    ...
    tmpl$F.stylesheets = [];
    tmpl$F.stylesheetToken = "lwc-5ju3kred9et";
    tmpl$F.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_ai";
    ...
    tmpl$E.stylesheets = [];
    tmpl$E.stylesheetToken = "lwc-59g8ia19job";
    tmpl$E.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_attachment";
    ...
    tmpl$C.stylesheets = [];
    tmpl$C.stylesheetToken = "lwc-46gslnl8mea";
    tmpl$C.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_box_notes";
    ...
    tmpl$B.stylesheets = [];
    tmpl$B.stylesheetToken = "lwc-118igb5ju2b";
    tmpl$B.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_csv";
    ...
    tmpl$A.stylesheets = [];
    tmpl$A.stylesheetToken = "lwc-7gnebkrnuem";
    tmpl$A.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_eps";
    ...
    tmpl$z.stylesheets = [];
    tmpl$z.stylesheetToken = "lwc-1r0vmq4qpds";
    tmpl$z.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_excel";
    ...
    tmpl$y.stylesheets = [];
    tmpl$y.stylesheetToken = "lwc-7i38u6af742";
    tmpl$y.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_exe";
    ...
    tmpl$x.stylesheets = [];
    tmpl$x.stylesheetToken = "lwc-22oc55fp113";
    tmpl$x.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_flash";
    ...
    tmpl$w.stylesheets = [];
    tmpl$w.stylesheetToken = "lwc-71suqn62rtf";
    tmpl$w.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_folder";
    ...
    tmpl$v.stylesheets = [];
    tmpl$v.stylesheetToken = "lwc-300koteeeuf";
    tmpl$v.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_gdoc";
    ...
    tmpl$u.stylesheets = [];
    tmpl$u.stylesheetToken = "lwc-2t9pub0kb2r";
    tmpl$u.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_gdocs";
    ...
    tmpl$t.stylesheets = [];
    tmpl$t.stylesheetToken = "lwc-5c51gg31ce3";
    tmpl$t.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_gform";
    ...
    tmpl$s.stylesheets = [];
    tmpl$s.stylesheetToken = "lwc-2gq43msq03i";
    tmpl$s.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_gpres";
    ...
    tmpl$r.stylesheets = [];
    tmpl$r.stylesheetToken = "lwc-4atgntt53hb";
    tmpl$r.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_gsheet";
    ...
    tmpl$q.stylesheets = [];
    tmpl$q.stylesheetToken = "lwc-1hdu4n0vsv7";
    tmpl$q.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_html";
    ...
    tmpl$p.stylesheets = [];
    tmpl$p.stylesheetToken = "lwc-3463io6rat8";
    tmpl$p.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_image";
    ...
    tmpl$o.stylesheets = [];
    tmpl$o.stylesheetToken = "lwc-739b2ut8j91";
    tmpl$o.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_keynote";
    ...
    tmpl$n.stylesheets = [];
    tmpl$n.stylesheetToken = "lwc-69qrt3iqao9";
    tmpl$n.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_library_folder";
    ...
    tmpl$m.stylesheets = [];
    tmpl$m.stylesheetToken = "lwc-7hqdi8bvoo9";
    tmpl$m.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_link";
    ...
    tmpl$l.stylesheets = [];
    tmpl$l.stylesheetToken = "lwc-4gtc0fkul7h";
    tmpl$l.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_mp4";
    ...
    tmpl$k.stylesheets = [];
    tmpl$k.stylesheetToken = "lwc-5ho888kltth";
    tmpl$k.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_overlay";
    ...
    tmpl$j.stylesheets = [];
    tmpl$j.stylesheetToken = "lwc-2c82l7uho8a";
    tmpl$j.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_pack";
    ...
    tmpl$i.stylesheets = [];
    tmpl$i.stylesheetToken = "lwc-30a5t5dkom0";
    tmpl$i.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_pages";
    ...
    tmpl$h.stylesheets = [];
    tmpl$h.stylesheetToken = "lwc-52i94p1u7dv";
    tmpl$h.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_pdf";
    ...
    tmpl$g.stylesheets = [];
    tmpl$g.stylesheetToken = "lwc-50p7npoqs7c";
    tmpl$g.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_ppt";
    ...
    tmpl$f.stylesheets = [];
    tmpl$f.stylesheetToken = "lwc-6usos1km0qk";
    tmpl$f.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_psd";
    lwc.freezeTemplate(tmpl$f);
    ...
    tmpl$e.stylesheets = [];
    tmpl$e.stylesheetToken = "lwc-70e03h70scq";
    tmpl$e.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_quip_doc";
    lwc.freezeTemplate(tmpl$e);
    ...
    tmpl$d.stylesheets = [];
    tmpl$d.stylesheetToken = "lwc-5m2bcrqc3iv";
    tmpl$d.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_quip_sheet";
    lwc.freezeTemplate(tmpl$d);
    ...
    tmpl$c.stylesheets = [];
    tmpl$c.stylesheetToken = "lwc-3bja9hom9o4";
    tmpl$c.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_quip_slide";
    lwc.freezeTemplate(tmpl$c);
    ...
    tmpl$b.stylesheets = [];
    tmpl$b.stylesheetToken = "lwc-5avndqvkd55";
    tmpl$b.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_rtf";
    lwc.freezeTemplate(tmpl$b);
    ...
    tmpl$a.stylesheets = [];
    tmpl$a.stylesheetToken = "lwc-1mnetn8kf7a";
    tmpl$a.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_shared_folder";
    lwc.freezeTemplate(tmpl$a);
    ...
    tmpl$8.stylesheets = [];
    tmpl$8.stylesheetToken = "lwc-vg1upgvipq";
    tmpl$8.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_stypi";
    ...
    tmpl$7.stylesheets = [];
    tmpl$7.stylesheetToken = "lwc-2picua0v4pq";
    tmpl$7.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_txt";
    ...
    tmpl$6.stylesheets = [];
    tmpl$6.stylesheetToken = "lwc-7jblsn94vcs";
    tmpl$6.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_unknown";
    ...
    tmpl$5.stylesheets = [];
    tmpl$5.stylesheetToken = "lwc-7a27gut1re9";
    tmpl$5.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_video";
    ...
    tmpl$4.stylesheets = [];
    tmpl$4.stylesheetToken = "lwc-ronlrpm13h";
    tmpl$4.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_visio";
    ...
    tmpl$3.stylesheets = [];
    tmpl$3.stylesheetToken = "lwc-6lg6pvd8vc9";
    tmpl$3.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_webex";
    ...
    tmpl$2.stylesheets = [];
    tmpl$2.stylesheetToken = "lwc-4tjnlb5cqbk";
    tmpl$2.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_word";
    ...
    tmpl$1.stylesheets = [];
    tmpl$1.stylesheetToken = "lwc-2anjd19tpv7";
    tmpl$1.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_xml";
    ...
    tmpl.legacyStylesheetToken = "lightning-iconSvgTemplatesDoctype_zip";
