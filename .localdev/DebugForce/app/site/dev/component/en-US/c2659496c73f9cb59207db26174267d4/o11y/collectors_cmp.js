...
(function() { LWR.define('o11y_schema/sf_instrumentation', ['exports'], (function (exports) {
	      ...
	      "sf": {
	        "nested": {
	          "instrumentation": {
	            "nested": {
	              "MouseEvent": {
	                "reserved": [[6, 6], [7, 7], [15, 15], [16, 16], [17, 17], [18, 18], [19, 19], [20, 20], [21, 21], [22, 22]],
	                "fields": {
	                  "cancelable": {
	                    "id": 5,
	                    "type": "bool"
...
(function() { LWR.define('o11y/collectors', ['exports', 'o11y/shared', 'o11y/core_envelope', 'o11y_schema/sf_instrumentation'], (function (exports, shared, core_envelope, sf_instrumentation) {
      ...
      !function (r, e, t) {
        ...
        14: [function (t, i, n) {
          ...
          function s(t, i, n, r, e, s) {
            ...
            if (this.valuesById = {}, this.values = Object.create(this.valuesById), this.comment = r, this.comments = e || {}, this.valuesOptions = s, this.reserved = g, i) for (var o = Object.keys(i), u = 0; u < o.length; ++u) "number" == typeof i[o[u]] && (this.valuesById[this.values[o[u]] = i[o[u]]] = o[u]);
          }
        ...
        15: [function (t, i, n) {
          ...
          function o(t, i, n, r, e, s, o) {
            ...
            this.rule = (r = "proto3_optional" === r ? "optional" : r) && "optional" !== r ? r : g, this.type = n, this.id = i, this.extend = e || g, this.required = "required" === r, this.optional = !this.required, this.repeated = "repeated" === r, this.map = !1, this.message = null, this.partOf = null, this.typeDefault = null, this.defaultValue = null, this.long = !!f.Long && h.long[n] !== g, this.bytes = "bytes" === n, this.resolvedType = null, this.extensionField = null, this.declaringField = null, this.o = null, this.comment = o;
          }
        ...
        21: [function (t, i, n) {
          ...
          function a(t, i) {
            r.call(this, t, i), this.nested = g, this.h = null;
          }
          function l(t) {
            return t.h = null, t;
          }
          a.fromJSON = function (t, i) {
            ...
            get: function () {
              return this.h || (this.h = h.toArray(this.nested));
            }
            ...
            if (t) for (var i, n = Object.keys(t), r = 0; r < n.length; ++r) i = t[n[r]], this.add((i.fields !== g ? e : i.values !== g ? o : i.methods !== g ? s : i.id !== g ? u : a).fromJSON(n[r], i));
            return this;
            ...
            } else for (var e = 0; e < this.nestedArray.length; ++e) if (this.h[e] instanceof a && (r = this.h[e].lookup(t, i, !0))) return r;
        ...
        22: [function (t, i, n) {
          ...
          Object.defineProperties(e.prototype, {
            ...
            t = t.root;
            t instanceof r && t.l(this);
          }, e.prototype.onRemove = function (t) {
            t = t.root;
            t instanceof r && t.v(this), this.parent = null, this.resolved = !1;
        ...
        24: [function (t, i, n) {
          ...
          h.create = f(), h.prototype.p = e.Array.prototype.subarray || e.Array.prototype.slice, h.prototype.uint32 = (c = 4294967295, function () {
            ...
            return this.pos += t, Array.isArray(this.buf) ? this.buf.slice(i, n) : i === n ? new this.buf.constructor(0) : this.p.call(this.buf, i, n);
        ...
        26: [function (t, i, n) {
          ...
          h.fromJSON = function (t, i) {
              ...
              try {
                if (b.isString(i) && "{" == (i[0] || "") && (i = JSON.parse(i)), b.isString(i)) {
                  ...
                  var n,
                    r = d(i, o, s),
                    e = 0;
                  if (r.imports) for (; e < r.imports.length; ++e) (n = f(r.imports[e]) || o.resolvePath(t, r.imports[e])) && a(n);
                  if (r.weakImports) for (e = 0; e < r.weakImports.length; ++e) (n = f(r.weakImports[e]) || o.resolvePath(t, r.weakImports[e])) && a(n, !0);
            ...
            function a(n, r) {
              if (n = f(n) || n, !~o.files.indexOf(n)) if (o.files.push(n), n in v) u ? c(n, v[n]) : (++l, setTimeout(function () {
                --l, c(n, v[n]);
              }));else if (u) {
                var t;
                try {
          ...
          h.prototype.l = function (t) {
            if (t instanceof s) t.extend === g || t.extensionField || c(0, t) || this.deferred.push(t);else if (t instanceof o) f.test(t.name) && (t.parent[t.name] = t.values);else if (!(t instanceof u)) {
              if (t instanceof r) for (var i = 0; i < this.deferred.length;) c(0, this.deferred[i]) ? this.deferred.splice(i, 1) : ++i;
              for (var n = 0; n < t.nestedArray.length; ++n) this.l(t.h[n]);
              f.test(t.name) && (t.parent[t.name] = t);
            }
          }, h.prototype.v = function (t) {
            var i;
            if (t instanceof s) t.extend !== g && (t.extensionField ? (t.extensionField.parent.remove(t.extensionField), t.extensionField = null) : -1 < (i = this.deferred.indexOf(t)) && this.deferred.splice(i, 1));else if (t instanceof o) f.test(t.name) && delete t.parent[t.name];else if (t instanceof e) {
              for (var n = 0; n < t.nestedArray.length; ++n) this.v(t.h[n]);
        ...
        30: [function (t, i, n) {
          ...
          var r = t(21),
            ...
            h = t(28);
          function o(t, i) {
            r.call(this, t, i), this.methods = {}, this.g = null;
          }
          function e(t) {
            return t.g = null, t;
          }
          o.fromJSON = function (t, i) {
            ...
            var i = r.prototype.toJSON.call(this, t),
              n = !!t && !!t.keepComments;
            return u.toObject(["options", i && i.options || g, "methods", r.arrayToJSON(this.methodsArray, t) || {}, "nested", i && i.nested || g, "comment", n ? this.comment : g]);
          }, Object.defineProperty(o.prototype, "methodsArray", {
            get: function () {
              return this.g || (this.g = u.toArray(this.methods));
            }
            ...
            for (var r, e = new h.Service(t, i, n), s = 0; s < this.methodsArray.length; ++s) {
              var o = u.lcFirst((r = this.g[s]).resolve().name).replace(/[^$\w_]/g, "");
        ...
        31: [function (t, i, n) {
          ...
          var o = t(21),
            ...
            m = t(37);
          function w(t, i) {
            o.call(this, t, i), this.fields = {}, this.oneofs = g, this.extensions = g, this.reserved = g, this.group = g, this.j = null, this.i = null, this.k = null, this.O = null;
          }
          function r(t) {
            return t.j = t.i = t.k = null, delete t.encode, delete t.decode, delete t.verify, t;
          }
          Object.defineProperties(w.prototype, {
                ...
                if (!this.j) {
                  ...
                  for (var t = Object.keys(this.fields), i = 0; i < t.length; ++i) {
                    var n = this.fields[t[i]],
                      r = n.id;
                    if (this.j[r]) throw Error("duplicate id " + r + " in " + this);
                    this.j[r] = n;
                  }
                }
                return this.j;
            ...
            oneofsArray: {
              get: function () {
                return this.k || (this.k = d.toArray(this.oneofs));
              }
            },
            ctor: {
              get: function () {
                return this.O || (this.ctor = w.generateConstructor(this)());
              },
              set: function (t) {
                for (var i = t.prototype, n = (i instanceof e || ((t.prototype = new e()).constructor = t, d.merge(t.prototype, i)), t.$type = t.prototype.$type = this, d.merge(t, e, !0), this.O = t, 0); n < this.fieldsArray.length; ++n) this.i[n].resolve();
                for (var r = {}, n = 0; n < this.oneofsArray.length; ++n) r[this.k[n].resolve().name] = {
                  get: d.oneOfGetter(this.k[n].oneof),
                  set: d.oneOfSetter(this.k[n].oneof)
                };
            ...
            var i = o.prototype.toJSON.call(this, t),
              n = !!t && !!t.keepComments;
            return d.toObject(["options", i && i.options || g, "oneofs", o.arrayToJSON(this.oneofsArray, t), "fields", o.arrayToJSON(this.fieldsArray.filter(function (t) {
            ...
            if (t instanceof f && t.extend === g) {
              if ((this.j || this.fieldsById)[t.id]) throw Error("duplicate id " + t.id + " in " + this);
        ...
        35: [function (t, i, n) {
          ...
          r.asPromise = t(1), r.base64 = t(2), r.EventEmitter = t(4), r.float = t(6), r.inquire = t(7), r.utf8 = t(10), r.pool = t(9), r.LongBits = t(34), r.isNode = !!("undefined" != typeof global && global && global.process && global.process.versions && global.process.versions.node), r.global = r.isNode && global || "undefined" != typeof window && window || "undefined" != typeof self && self || this, r.emptyArray = Object.freeze ? Object.freeze([]) : [], r.emptyObject = Object.freeze ? Object.freeze({}) : {}, r.isInteger = Number.isInteger || function (t) {
          ...
          }, r.Buffer = null, r.A = null, r.T = null, r.newBuffer = function (t) {
            return "number" == typeof t ? r.Buffer ? r.T(t) : new r.Array(t) : r.Buffer ? r.A(t) : "undefined" == typeof Uint8Array ? t : new Uint8Array(t);
            ...
            var n = r.Buffer;
            n ? (r.A = n.from !== Uint8Array.from && n.from || function (t, i) {
              return new n(t, i);
            }, r.T = n.allocUnsafe || function (t) {
              return new n(t);
            }) : r.A = r.T = null;
          };
        }, {
          ...
          n[".google.protobuf.Any"] = {
            ...
            toObject: function (t, i) {
              var n,
                ...
                e = "",
                s = "";
              return !((t = i && i.json && t.type_url && t.value && (s = t.type_url.substring(1 + t.type_url.lastIndexOf("/")), e = t.type_url.substring(0, 1 + t.type_url.lastIndexOf("/")), n = this.lookup(s)) ? n.decode(t.value) : t) instanceof this.ctor) && t instanceof o ? (n = t.$type.toObject(t, i), r = "." === t.$type.fullName[0] ? t.$type.fullName.slice(1) : t.$type.fullName, n["@type"] = s = (e = "" === e ? "type.googleapis.com/" : e) + r, n) : this.toObject(t, i);
            }
          };
        }, {
          19: 19
        ...
        38: [function (t, i, n) {
          ...
          }, e.Array !== Array && (a.alloc = e.pool(a.alloc, e.Array.prototype.subarray)), a.prototype.S = function (t, i, n) {
          ...
          a.prototype.bytes = function (t) {
            var i,
              n = t.length >>> 0;
            return n ? (e.isString(t) && (i = a.alloc(n = o.length(t)), o.decode(t, i, 0), t = i), this.uint32(n).S(y, n, t)) : this.S(d, 1, 0);
          }, a.prototype.string = function (t) {
            var i = u.length(t);
            return i ? this.uint32(i).S(u.write, i, t) : this.S(d, 1, 0);
        ...
        39: [function (t, i, n) {
          ...
          s.u = function () {
            s.alloc = e.T, s.writeBytesBuffer = e.Buffer && e.Buffer.prototype instanceof Uint8Array && "set" === e.Buffer.prototype.set.name ? function (t, i, n) {
              i.set(t, n);
            } : function (t, i, n) {
              if (t.copy) t.copy(i, n, 0, t.length);else for (var r = 0; r < t.length;) i[n++] = t[r++];
            };
          }, s.prototype.bytes = function (t) {
            var i = (t = e.isString(t) ? e.A(t, "base64") : t).length >>> 0;
            return this.uint32(i), i && this.S(s.writeBytesBuffer, i, t), this;
          }, s.prototype.string = function (t) {
            var i = e.Buffer.byteLength(t);
            return this.uint32(i), i && this.S(o, i, t), this;
          }, s.u();
        }, {
          35: 35,
          38: 38
    ...
    class ProtobufUtil {
      ...
      getSchemaType(schema) {
        shared.utility.requireArgument(schema, 'schema');
        const schemaPath = shared.schemaUtil.getSchemaId(schema);
      ...
      validate(schema, data) {
        shared.utility.requireArgument(schema, 'schema');
        shared.utility.requireArgument(data, 'data');
      ...
      encodePayload(rawPayload) {
        if ((rawPayload === null || rawPayload === void 0 ? void 0 : rawPayload.schema) && rawPayload.payload) {
          return {
            schemaName: shared.schemaUtil.getSchemaId(rawPayload.schema),
      ...
      processRawLogMessage(schema, raw) {
        ...
        if (shared.schemaUtil.isInternal(schema) && dataClone.userPayload) {
    ...
    const root = __protobufjs.Root.fromJSON(sf_instrumentation.coreEnvelopeSchema.pbjsSchema);
    ...
    function envelopeContents(contents) {
      return core_envelope.CoreEnvelopeBuilder.buildFrom(contents);
    }
    ...
    class CoreCollector {
      constructor(uploadEndpoint, uploadMode, environment, options) {
        ...
        if (options) {
          ...
          if (shared.utility.requireArgumentIfDefined(options.formDataKeyName, 'options.formDataKeyName', 'string')) {
            this._formDataKey = options.formDataKeyName;
          }
          if (shared.utility.requireArgumentIfDefined(options.uploadFailedListener, 'options.uploadFailedListener', 'function')) {
      ...
      set uploadEndpoint(uploadEndpoint) {
        shared.utility.requireArgumentIfDefined(uploadEndpoint, 'uploadEndpoint', 'string');
      ...
      set uploadOptionsCallback(uploadOptionsCallback) {
        shared.utility.requireArgumentIfDefined(uploadOptionsCallback, 'uploadOptionsCallback', 'function');
      ...
      set uploadMode(uploadMode) {
        shared.utility.requireArgumentIfDefined(uploadMode, 'uploadMode', 'number');
      ...
      getByteSize(accuracy) {
        return accuracy >= 1 ? this._buildProtoEncodedCoreEnvelope(false).byteLength : accuracy >= 0.5 ? this._emptySize + this._messageSize + this.metricsCount * 8 : this._emptySize + this._messageSize;
      }
      _stopTimer() {
      ...
      async collect(schema, data, logMeta) {
        if (shared.schemaUtil.isInternal(schema) && data.userPayload) {
      ...
      _shouldUpload() {
        return this._immediateUpload && this.hasData || this.messagesCount >= this._messagesLimit || this.metricsCount >= this._metricsLimit;
      }
      ...
      async upload(contents) {
        ...
        if (shared.utility.requireArgumentIfDefined(contents, 'contents', 'object')) {
      ...
      _getContentsOfCoreEnvelope(extract) {
        ...
        if (this._metricsExtractors) {
          contents.upCounters = core_envelope.CoreEnvelopeBuilder.getUpCounters(this._metricsExtractors.getAllUpCounters(), extract);
          contents.valueRecorders = core_envelope.CoreEnvelopeBuilder.getValueRecorders(this._metricsExtractors.getAllValueRecorders(), extract);
          contents.bucketHistograms = core_envelope.CoreEnvelopeBuilder.getBucketHistograms(this._metricsExtractors.getAllBucketHistograms(), extract);
        }
        if (extract) {
          this._messageSize = 0;
        }
    ...
    class HybridCollector {
      ...
      collect(schema, data, logMeta) {
        ...
        this._observability.log(shared.schemaUtil.getSchemaId(schema), logMessage.data, logMetaObs);
      }
      receiveMetricsExtractors(metricsExtractors) {
        this._metricsExtractors = metricsExtractors;
      }
    ...
    exports.CoreCollector = CoreCollector;
    exports.HybridCollector = HybridCollector;
    exports.encodeCoreEnvelopeContentsRaw = encodeCoreEnvelopeContentsRaw;
    exports.processRawContents = processRawContents;
